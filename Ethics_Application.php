...
<p>According to section 5.1.6 (b) of the National Statement if your study involves any of the following groups the project MUST be reviewed by the HREC.<br /><br /></p>
    ...
    <textarea name="TriageJustify" cols="205" rows="7" id="TriageJustify" onchange="triageJustUD();" disabled="disabled"><?php if (isset($TriageJust)) echo $TriageJust; else echo "";?></textarea>
		...
		<table style="border-collapse: collapse;width:75%">
            ...
            A clinical trial is defined as any research project that prospectively assigns human subjects to intervention and comparison groups to 
            ...
            to modify a health outcome. This definition includes, drugs, surgical procedures, devices, behavioral treatments, process-of-care change etc.
				</td>
			</tr>
		</table>
		...
		<table style="border-collapse: collapse;width:75%">
			<tr>
				<td style="border:1px solid black;border-top:none;width:5%"> <input name="Q13input01" onClick="Q13input01UD();" type="radio" <?php if (isset($PQ13input01) && $PQ13input01=="No") echo "checked";?> value="No" id="Q13input01_yes"/> </td>
		...
		<br>
            ...
            <table width = 800>
                <tr>
                	<td>
                		<div id="formCheckBox">
                			<input type="radio" name="Q13ainput01" onClick="Q13ainput01UD();" <?php if (isset($PQ13ainput01) && $PQ13ainput01=="No") echo "checked";?> value="No" id="Q13ainput01_no" />No - <i>please outline why a placebo or non-treatment group will not be used.</i>
                		</div>
                	</td>
                	<td>
                		<div id="formCheckBox">
                			<input type="radio" name="Q13ainput01" onClick="Q13ainput01UD();" <?php if (isset($PQ13ainput01) && $PQ13ainput01=="Yes") echo "checked";?> value="Yes" id="Q13ainput01_yes" />Yes - <i>please describe why a placebo or non-treatment group is the best comparator.</i>
                		</div>
                	</td>
                </tr>
            </table>
            <th><label class="normal" id="Q13ainput02L"><span class="red">*</span></label></th>
	    <textarea name="Q13ainput02" id="Q13ainput02" onBlur="Q13ainput02UD();" cols="205" rows="7"><?php if (isset($PQ13aintput02))echo $PQ13ainput02; ?></textarea> 
