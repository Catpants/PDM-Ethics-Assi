...
function requireNone()
{
	if(getCheckedValue(document.forms['AppForm'].elements['savesub']) == "save")
	{
		...
		change('Q13ainput01L', 'normal');
		change('Q13ainput02L', 'normal');
	}
}
...
function Q13input01UD() {
	if((getCheckedValue(document.forms['AppForm'].elements['savesub']) == "submit") && (getCheckedValue(document.forms['AppForm'].elements['Q13input01']) == ""))
	{
...
function Q13ainput01UD() {
	if((getCheckedValue(document.forms['AppForm'].elements['savesub']) == "submit") && (getCheckedValue(document.forms['AppForm'].elements['Q13ainput01']) == ""))
	{
		change('Q13ainput01L', 'required');
	}
	else
	{
		change('Q13ainput01L', 'normal');
...
function Q13ainput02UD() {
	if((getCheckedValue(document.forms['AppForm'].elements['savesub']) == "submit") && (getTextValue("Q13ainput02") == ""))
	{
		change('Q13ainput02L', 'required');
	}
	else
	{
		change('Q13ainput02L', 'normal');
